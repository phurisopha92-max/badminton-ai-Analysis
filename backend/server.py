...

{
  ...
  "timestamps": [
    {"time": "0:01", "seconds": 1, "type": "จุดเด่น", "category": "ท่าทาง", "title": "...", "description": "..."},
    {"time": "0:03", "seconds": 3, "type": "ปัญหา", "category": "ฟุตเวิร์ค", "title": "...", "description": "..."},
    {"time": "0:05", "seconds": 5, "type": "จุดเด่น", "category": "ท่าทาง", "title": "...", "description": "..."},
    {"time": "0:08", "seconds": 8, "type": "ปัญหา", "category": "ท่าทาง", "title": "...", "description": "..."},
    {"time": "0:10", "seconds": 10, "type": "จุดเด่น", "category": "ฟุตเวิร์ค", "title": "...", "description": "..."}
  ],
...
4. **ระบุ timestamps สำคัญ (สำคัญที่สุด! ต้องมีอย่างน้อย 5-10 จุด)**: 
   - **ดูวิดีโอทีละเฟรม** และจดเวลาที่เห็นเหตุการณ์จริงๆ
   - **ระบุให้มากที่สุดเท่าที่เห็น** ทุกครั้งที่มีการตีลูก เคลื่อนที่ หรือทำท่าทางใดๆ
   ...
   - **ระบุทั้งจุดดีและจุดที่ต้องปรับปรุง** ให้มีทั้งสองประเภทอย่างสมดุล
   - type: "ปัญหา" = สิ่งที่ต้องแก้ไข (สีแดง)
   - type: "จุดเด่น" = สิ่งที่ทำได้ดี (สีเขียว)
   - category: "ท่าทาง" หรือ "ฟุตเวิร์ค"
   - title: ชื่อสั้นๆ เช่น "สแมชดี", "ไม่ย่อเข่า", "สปลิทสเต็ปถูกจังหวะ"
   - description: อธิบายรายละเอียดสิ่งที่เห็น ณ วินาทีนั้น
   - **ยิ่งมี timestamps มาก ยิ่งดี!** ควรมีอย่างน้อย 1 จุดทุกๆ 2-3 วินาทีของวิดีโอ
...
- **timestamps ยิ่งมากยิ่งดี** อย่างน้อย 5-10 จุด หรือมากกว่านั้นถ้าวิดีโอยาว
